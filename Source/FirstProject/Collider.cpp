...
ACollider::ACollider()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshComponentsAsset(TEXT("StaticMesh'/Game/StarterContent/Shapes/Shape_Sphere.Shape_Sphere'"));
	if (MeshComponentsAsset.Succeeded()) {
		MeshComponent->SetStaticMesh(MeshComponentsAsset.Object);
